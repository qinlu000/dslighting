"""Run AgenticDataBench DataCOPE discovery in the existing isolated Codex runtime."""
...
DEFAULT_SIDECAR_TIMEOUT_SECONDS = 2 * 60 * 60
...
def run_sidecar(
    *,
    ...
    previous_skill = (
        Path(previous_skill_dir).expanduser().resolve()
